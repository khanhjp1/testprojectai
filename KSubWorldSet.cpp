...
//	//	//	pScript->SetGlobalName(SCRIPT__SubWorldINDEX);			
//	//	     nTopIndex=pScript->SafeCallBegin();
...
//BOOL KSubWorldSet::SendMessage(int n_SubWorldID, DWORD dwMsgType, int nParam1, int nParam2, int nParam3)
//{
...
//
//	return SubWorld[n_SubWorldID].m_WorldMessage.Send(pNode);*/
//	return false;
//}
//离开游戏时调用的函数
...
//	//m_cMusic.Stop();
//}
//void KSubWorldSet::SetPing(DWORD dwTimer)
//{
//	m_dwPing = dwTimer;
//}

//DWORD KSubWorldSet::GetPing()
//{
//	return m_dwPing;
//}
//DWORD KSubWorldSet::GetGameTime()
//{
//	return m_nLoopRate;
//}
//int KSubWorldSet::GetGameVersion()
//{
